...
Drawable::Drawable() : _matrixToUse(0){
	_current = new Matrix();
}

Drawable::Vertex* Drawable::parseVertexInfo(char* objectName){
...
void Drawable::explode(std::string const & s, char delim, float* result){
	int i = 0;
